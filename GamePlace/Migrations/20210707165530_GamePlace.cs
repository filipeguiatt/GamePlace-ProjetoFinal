...
{
    public partial class GamePlace : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AnoLancamento = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UtilizadorRegistado", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdRecursos = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    NomeRecurso = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ImagemJogo = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LinkVideos = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Compras_Jogos_JogoFK",
                        column: x => x.JogoFK,
                        principalTable: "Jogos",
                        principalColumn: "IdJogo",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Compras_UtilizadorRegistado_UtilizadorFK",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "u", "f037a4d1-8fec-46c0-8b39-cc0a3a6b1ecc", "Utilizador", "UTILIZADOR" });

            migrationBuilder.InsertData(
                table: "AspNetRoles",
                columns: new[] { "Id", "ConcurrencyStamp", "Name", "NormalizedName" },
                values: new object[] { "a", "19e1c116-4587-4987-9f34-48a61c073028", "Admin", "ADMIN" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Compras_JogoFK",
                table: "Compras",
                column: "JogoFK");

            migrationBuilder.CreateIndex(
                name: "IX_Compras_UtilizadorFK",
                table: "Compras",
                column: "UtilizadorFK");

            migrationBuilder.CreateIndex(
                name: "IX_Recursos_JogoFK",
                table: "Recursos",
                column: "JogoFK");
        }
